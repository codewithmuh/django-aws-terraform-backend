...
SECRET_KEY = 'django-insecure-n$z^ch$04t(53&m9yskr@0#s_z=u$qeh&0kwbfjb!%y@7h(&b4'
...
DATABASES = {
'default': env.db(default="postgresql://postgres:postgres@127.0.0.1:5434/django_aws")
}
